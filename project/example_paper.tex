...
In the third example, we use the UCB algorithm in the first 100
 stages, and then we use the EXP3 algorithm. In Figure~\ref{fig: tah3}, we can see that its performance is better than the EXP3 algorithm but worse than the UCB algorithm. However, it is faster than the UCB algorithm.
...
{
\centering
\includegraphics[width=0.50\textwidth]{UCBEXP3}
\caption{Mixture of UCB and EXP3 algorithms. \label{fig: tah3}}
}
\end{figure}
